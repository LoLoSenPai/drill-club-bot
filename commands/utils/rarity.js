...
module.exports = {
	...
	async execute(interaction) {
		...
		try {
			...
			// const imageNftData = data.extra_metadata.image_original_url;
			const imageNft = `https://bafybeigt7ksjejyxksjs5qlu6zyagpeghvy4orfysrsx32ds7vyie77ozi.ipfs.dweb.link/${numb}.png`;
